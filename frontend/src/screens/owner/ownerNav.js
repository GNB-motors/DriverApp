/** Sidebar navigation config for the Owner demo surface. */
export const OWNER_NAV = [
  {
    ...
    items: [
      ...
      { key: 'OwnerDriversDashboard', label: 'Drivers', icon: 'people-outline' },
      ...
      { key: 'OwnerProfile',  label: 'Profile',         icon: 'person-outline' },
    ],
  },
];
